...
// ** Dropdowns
import helth from '@/constants/dropdownLists/benifitNames/helth'
...
export const EditDetailsHealthBenefits = () => {
  ...
  return (
    <Box>
      <FormWrapper title='Helth Insurance' onSubmit={handleSubmit(onSubmit)}>
                ...
                <Controller
                  ...
                  render={({ field }) => {
                    ...
                    return (
                      <Autocomplete
                        freeSolo
                        options={key === 'name' ? helth : currencyCode}
                        inputValue={isNameField && value === '' ? 'Health ' : value}
