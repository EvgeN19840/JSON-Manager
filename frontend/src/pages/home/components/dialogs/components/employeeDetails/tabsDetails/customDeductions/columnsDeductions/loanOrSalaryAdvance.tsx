...
export const ColumnsLoansOrAdvances = (
  _handleEditClick: (data: ILoanOrSalaryAdvance) => void,
  callbacks: ContextMenuItemsCallbacks<ILoanOrSalaryAdvance>
): GridColDef<ILoanOrSalaryAdvance>[] => [
  {
    field: 'name',
    headerName: 'Name',
    minWidth: 150,
  ...
  },
  {
    ...
    sortable: false,
    filterable: false,
    renderCell: (params: GridRenderCellParams<ILoanOrSalaryAdvance>) => {
